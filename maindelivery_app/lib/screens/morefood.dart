...
class _MoreFoodXDState extends State<MoreFoodXD> {
  List _popularList = [
    ...
    new Food('img/dinner2.png', 'Panner Butter Masala', 'Dinner , Eastern',
        '50', 'DINNERON', '4.5', '12 min', '25'),
    new Food('img/dinner1.png', 'Butter Roti', 'Veg', '40', 'DAILYDINNER',
        '4.0', '10 min', '5'),
  ...
  List _specialList = [
    new Food('img/specialfood1.png', 'Egg Roll', 'Snacks', '4', 'EATSNACK',
        '4.0', '10 min', '10'),
    new Food('img/specialfood2.png', 'Chicken Lollipop', 'Snacks', '5',
        'EATSNACK', '4.0', '10 min', '25'),
    new Food('img/dinner2.png', 'Panner Butter Masala', 'Dinner , Eastern',
        '50', 'DINNERON', '4.5', '12 min', '25'),
    new Food('img/breakfast4.png', 'Oats - Fruits Mixed', 'Starter , Veg', '30',
        'DAILYFOOD', '4.0', '5 min', '15'),
