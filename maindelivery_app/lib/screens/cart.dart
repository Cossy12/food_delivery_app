...
import 'package:maindelivery_app/screens/coupon.dart';
import 'package:maindelivery_app/screens/payment.dart';
import 'package:maindelivery_app/transition/scale.dart';
import 'package:maindelivery_app/utils/config.dart';
import 'package:maindelivery_app/utils/helper.dart';
...
class _CartXDState extends State<CartXD> {
                      ...
                      : Column(
                          children: <Widget>[
                            ...
                            GestureDetector(
                              onTap: () {
                                Navigator.push(
                                    context, ScaleRoute(page: CouponXD()));
                              },
                              child: Row(
                                children: <Widget>[
                                  Image.asset(
                                  ...
                                  SizedBox(
                                    width: SizeConfig.safeBlockHorizontal * 4.4,
                                  ),
                                  Text(
                                    'APPLY COUPON',
                                    style: TextStyle(
                            ...
                            RaisedButton(
                              ...
                              onPressed: () {
                                Navigator.push(
                                    context, ScaleRoute(page: PaymentXD()));
                              },
                              child: Container(
  ...
  adjustPrice(int tempPrice, bool flag) {
    setState(() {
      price = flag ? price + tempPrice : price - tempPrice;
    });
  }
}
